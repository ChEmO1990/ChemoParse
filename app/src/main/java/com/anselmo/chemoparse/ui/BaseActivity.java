    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch ( id ) {
            ...
            case R.id.action_logout:
                ParseUser.logOut();
                Toast.makeText(BaseActivity.this, getString(R.string.msj_close_session), Toast.LENGTH_LONG).show();
            ...
            case R.id.add_item:
                Intent intent = new Intent(BaseActivity.this, AddCommentActivity.class);
